...
export function POSSearchBar({
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      {/* Barcode Scanner Toggle Button - Icon Only */}
      {onBarcodeScan && (
        <button
          onClick={toggleBarcodeScanner}
          className={`
            p-3 rounded-xl min-h-[48px] min-w-[48px] transition-all duration-200 ease-out
          ...
          `}
          title={barcodeScannerEnabled ? 'Barcode scanner enabled - Click to disable' : 'Barcode scanner disabled - Click to enable'}
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
