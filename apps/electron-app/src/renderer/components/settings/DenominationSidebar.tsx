...
import { Button, Sidebar } from '../common'
import { 
...
/**
 * DenominationSidebar - Sidebar for managing cash denominations
 * 
 * Features:
 * - Add/edit/remove denominations for the current currency
 * - Toggle denominations on/off
 * - Reset to default denominations
 * - Currency-specific configuration
 */
export function DenominationSidebar({ isOpen, onClose }: DenominationSidebarProps) {
  ...
  }, [isOpen, currencyConfig?.code, currencyConfig?.symbol, currencyConfig?.symbolPosition, currencyConfig?.decimalPlaces, business?.denominationsConfig])
